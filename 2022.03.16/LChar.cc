...
int main(){
  ...
  cout<<sizeof(mystring3)<<endl;
  strcpy(mystring3, "Dzien dobryyyyyyyyyyyyyyyyyyyyyyyyyyyaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaayyyyyyyyyyyyyyyyyyyyyyyy");
  cout<<sizeof(mystring3)<<endl;
  //strcpy(mystring3, "Dzien dobry wszystkim"); //A co jesli tekst bedzie dluzszy
  cout <<"mystring3: " <<mystring3 << endl;
  cout <<"mystring3: " <<mystring3[20] << endl;
